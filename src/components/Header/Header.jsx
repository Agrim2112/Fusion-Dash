            ...
            <header className={`main-header ${scrolled ? "sticky-header" : ""}`}>
                <div className="header-content">
                    ...
                    <ul className={`center ${mobileMenuOpen ? "open" : ""}`} >
                        ...
                        <li style={selectedButton === 2 ? whiteButton : darkButton} onClick={() => { navigate("/Merch"); setSelectedButton(2);toggleMobileMenuSpecific()  }}>Student</li>
                        <li style={selectedButton === 3 ? whiteButton : darkButton} onClick={() => { navigate("/Library"); setSelectedButton(3);toggleMobileMenuSpecific()  }}>Staff</li>
                        <li style={selectedButton === 4 ? whiteButton : darkButton} onClick={() => { navigate("/about"); setSelectedButton(4);toggleMobileMenuSpecific()  }}>Institute</li>
                    </ul>
                </div>
            </header>
        </>
